...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <a href="https://wa.me/6283167987800?text=Halo%20astrina%20saya%20tertarik%20membuat%20website%20toko%20online%20seperti%20Urban%20Wear%20di%20demo4.astmay.space%20bisakah%20saya%20dapat%20free%20konsultasi%20%3F" target="_blank" rel="noopener noreferrer" className="bg-primary-fixed text-on-primary-fixed px-6 py-2 font-bold uppercase tracking-tighter text-sm hover:bg-white transition-all duration-200 active:scale-95 inline-block text-center">
